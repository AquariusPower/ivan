...
{
  igraph::Blit3(Image.Picture, BlitData, MF_AL | MF_FLOOR);
}
...
void fluid::Draw(blitdata& BlitData) const
{
  ...
  if(SpecialFlags & 0x7)
  {
    ...
    igraph::Blit3(igraph::GetFlagBuffer(), BlitData, MF_AL | MF_OBJECT);
  }
  else
  {
    igraph::Blit3(Picture, BlitData, MF_AP | MF_OBJECT);
  }
...
void fluid::DrawGearPicture(blitdata& BlitData, int SpecialFlags) const
{
  ...
  {
    Picture->BlitAndCopyAlpha(igraph::GetFlagBuffer(), SpecialFlags);
    igraph::Blit3(igraph::GetFlagBuffer(), BlitData, MF_AP | MF_OBJECT);
  }
  else
  {
    igraph::Blit3(GearImage->Picture, BlitData, MF_AP | MF_OBJECT);
  }
...
void fluid::DrawBodyArmorPicture(blitdata& BlitData, int SpecialFlags) const
{
  ...
  igraph::Blit3(GearImage[Index].Picture, BlitData, MF_AP | MF_OBJECT); 
