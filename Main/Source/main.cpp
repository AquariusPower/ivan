...
int main(int argc, char** argv)
{
  ...
  if(argc > 1 && festring(argv[1]) == "--help")
  {
    ...
    std::cout << "--bonesarefun Cheater! Will generate bones file as often as possible on player's death." << std::endl;
    return 0;
  }
  ...
  {
    if(festring(argv[i]) == "--bonesarefun")
    {
      game::SetBonesAreFun(true);
    }
  }
